...
<div class="content-wrapper">
    <div class="container-fluid">
		...
		<div class="form-group">
			...
			<input class="form-control" name="noticename" type="text" maxlength="30" value=""/>
		</div>
		
		<div class="form-group">
			<label for="name"><span style='color: red;'>*</span>내 용</label>
			<textarea class="form-control" name="noticeContent" cols="41" rows="15"></textarea>
		</div>
