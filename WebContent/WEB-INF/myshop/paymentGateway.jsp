...
//	여기 링크를 꼭 참고하세용D
    ...
    IMP.init('imp15773829');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드". 
 	
    // 결제요청하기
    IMP.request_pay({
        pg : 'danal', // 결제방식 PG사 구분
        ...
        buyer_addr : '',  
        buyer_postcode : '',
        m_redirect_url : 'http://192.168.50.5:9090/semiProject/orderadd.do' // 결제 완료 후 action : 컨트롤러로 보내서 자체 db에 입력시킬것! */
    }, function(rsp) {
        /*
 		   if ( rsp.success ) {
 			   var msg = '결제가 완료되었습니다.';
 	   ...
 	   */
 		...
 		*/
 		...
 		//    self.close();
 			alert("결제성공");
 			location.href="orderadd.do";
             
         } else {
        	 alert("결제에 실패하였습니다.");
             location.href="javascript:history.back();";
            /*
             window.opener.orderCheck();
             self.close();  */ 
        }
