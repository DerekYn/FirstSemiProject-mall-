...
<form name="idFindFrm">
   <div id="div_name">
      ...
      <input type="text" class="form-control" name="name" id="name" size="15" placeholder="홍길동" required />
   </div>
   
   <div id="div_mobile">
   	  <span style="color: blue; font-size: 12pt;">휴대전화 :</span><br/>
      <input type="text" class="form-control"  name="mobile" id="mobile" size="15" placeholder="-없이 입력하세요" required />
   </div>
