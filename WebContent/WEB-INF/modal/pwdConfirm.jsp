...
<form name="pwdConfirmFrm">
   <div id="div_pwd" align="center">
      ...
      <input type="password" name="password" id="password" size="15" placeholder="PASSWORD" required />
   </div>
   
   <div id="div_pwd2" align="center">
   	  <span style="color: blue; font-size: 12pt;">새암호확인</span><br/>
      <input type="password" name="password2" id="password2" size="15" placeholder="PASSWORD" required />
   </div>
