...
<%-- 구글맵 api 사용하기  --%>
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCp5jHmxtERMC_-DiqCfQAXehrnAJ1JkbA"></script>
...
--%>			
		...
		setMarkers(targetmap, storeArr);//맵을보여주는..........?
		...
		var infowindow = new google.maps.InfoWindow(  
				{  content: '안녕하세요~', 
				   content: marker.title,	
				    ...
				    size: new google.maps.Size(100,100)  // 풍선창의 크기
				});
